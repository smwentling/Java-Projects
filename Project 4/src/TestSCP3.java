...
// TEST CASE THAT RUNS PRINT COMPARISON TWICE ( MOSTLY TO TEST IF BACK TO BACK SOLVE() FUNCTIONS WILL OUTPUT THE CORRECT ANSWER)
public class TestSCP3 {
	...
	public static void main(String[] args) throws IOException {
		...
		SCPModel model;
                File f = new File("src/file/SCPInstances/SCP_S_20-40.txt");
                model = ReadModel(f);
