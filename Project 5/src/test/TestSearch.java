...
public class TestSearch {
	...
	public static void main(String[] args) {
		...
		TestIndex(new soln.index.InvertedIndex(new io.StaticDocSource(),new tokenizer.SimpleTokenizer(),new score.TFScoringFun()));
		...
		TestIndex(new soln.index.InvertedIndex(new soln.io.FileDocSource("../Part1/awards_1994/awd_1994_00"), new soln.tokenizer.IndexingTokenizer(),new soln.score.TFIDFScoringFun()));
		...
		TestIndex(new index.InvertedIndex(new io.FileDocSource("../Part1/awards_1994/awd_1994_00"),new tokenizer.IndexingTokenizer(), new score.TFIDFScoringFun()));
	}
